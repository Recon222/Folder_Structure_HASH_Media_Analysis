...
class AdobeTheme:
    ...
    def get_stylesheet(self) -> str:
        ...
        /* ComboBox - AGGRESSIVE fix for white border issue */
        QComboBox {{
            background: {self.variables.get('surface_sunken')};
            background-color: {self.variables.get('surface_sunken')};
            color: {self.variables.get('text_primary')};
            border: 1px solid {self.variables.get('border_subtle')};
            border-top: 1px solid {self.variables.get('border_subtle')};
            border-left: 1px solid {self.variables.get('border_subtle')};
            border-right: 1px solid {self.variables.get('border_subtle')};
        ...
        QComboBox:hover {{
            ...
            border-top: 1px solid {self.variables.get('border_strong')};
            border-left: 1px solid {self.variables.get('border_strong')};
            border-right: 1px solid {self.variables.get('border_strong')};
            border-bottom: 1px solid {self.variables.get('border_strong')};
        }}

        QComboBox:focus {{
            border: 1px solid {self.variables.get('border_focus')};
            border-top: 1px solid {self.variables.get('border_focus')};
            border-left: 1px solid {self.variables.get('border_focus')};
            border-right: 1px solid {self.variables.get('border_focus')};
            border-bottom: 1px solid {self.variables.get('border_focus')};
        ...
        /* Drop-down sub-control - completely override */
        QComboBox::drop-down {{
            ...
            background-color: {self.variables.get('surface_sunken')};
            border-top-right-radius: {self.variables.get('border_radius')};
            border-bottom-right-radius: {self.variables.get('border_radius')};
        }}
        ...
        QComboBox::down-arrow {{
            ...
            border-top: 5px solid {self.variables.get('text_secondary')};
            margin-right: 8px;
        }}

        QComboBox:hover::down-arrow {{
            border-top: 5px solid {self.variables.get('text_primary')};
        }}

        QComboBox:on::down-arrow {{
            border-top: 5px solid {self.variables.get('primary')};
        }}

        /* Disable native frame painting */
        QComboBox:!frame {{
            border: 1px solid {self.variables.get('border_subtle')};
        }}
